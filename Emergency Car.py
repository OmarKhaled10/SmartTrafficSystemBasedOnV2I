...
def Btn_emerg_Action():
    client.publish(my_topic, payload="fasa7", qos=0, retain=False)
...
Btn_emerg = tk.Button(frame1,text="SOUND ALARM", bg = "white" , width = 10, height = 5, command = Btn_emerg_Action)
